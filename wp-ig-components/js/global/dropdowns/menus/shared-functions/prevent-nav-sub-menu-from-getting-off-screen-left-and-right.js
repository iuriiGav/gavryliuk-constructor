export const preventNavSubMenuFromGettingOffScreenLeftAndRight = function (breakpoint, dropdownTrigger) {
      ...
      if (dropdownHiddenContentContainer !== null && dropdownHiddenContentContainer !== undefined) {
        ...
        if (ulNavContainer.classList.contains("dma--centered-dropdown")) {
          ...
          if (
            ...
            dropdownHiddenContentContainer.style.marginLeft =
              -Math.abs(
                hiddenContentPosition.right +
                  parseFloat(dropdownHiddenContentContainerWidth) / 2 -
                  window.innerWidth +
                  28
              ) + "px";
          }
